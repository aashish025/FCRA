$(document).ready(function(){	
	...
	getAvailablePrivileges($("#roleId").val());	
});
function getAvailablePrivileges(roleId){	
	if(roleId==""){		
		$('.toggle').each(function(){
			$(this).addClass('hide');
		});
		...
		oplr();
		$.pullJSON('get-previleges-role-menu', params, function(data) {			
...
function addRemovePrevileges(fromObjName, toObjName){	
...
function saveDetails(){	
    ...
    document.forms.RoleMenu.submit();    
}