...
<script type="text/javascript"	src="resources/js/services/change-association-type.js"></script>
...
<title>Change Association Type</title>
</head>
<body id="">
			...
			<div id="rcn-search-detail">
				...
				<div class="row">
					<div class="col-xs-12 pp-form-field" id="app-info"
						...
						<div class="bs-callout bs-callout-info">
							<span id="asso-details-title">Change Association Type</span>
						</div>
						<form action="" method="get" id="changeAsso-type-form">
						<div class="row">
							<div class="col-sm-2">
								<select id="assocType" name="assocType"	class="form-control clear validate[required,maxSize[1]] title-l">
									<option value="">Select Association Type</option>
									<c:forEach items="${associationType}" var="gType">
										<option value='<c:out value="${gType.li}"/>'><c:out
												value="${gType.ld}" /></option>
									</c:forEach>
								</select>
							</div>
						</div>
						...
						<div class="row"> 
							<div class="col-xs-3 pp-form-field">
									<button type="button" class="btn btn-primary" onclick="javascript:submitAssociationType();">
