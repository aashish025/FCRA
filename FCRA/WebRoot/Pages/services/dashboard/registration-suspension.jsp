...
<head>
	...
	<script type="text/javascript" src="resources/js/services/dashboard/registration-suspension.js?Version=2.0"></script>
		...
		<div class="content-section">
			...
			<div class="row" id="application-list-div" style="display:none;">		 			 	
		     ...
		     <div class="col-xs-12 pp-form-field" id="actions" style="display:none;">						          
			      ...
			      <span class="glyphicon glyphicon-remove"></span>&nbsp; Suspend Registration</button>
			      <button type="button" id="revoke-btn" class="btn btn-success" onclick="clearModal();" data-toggle="modal" data-target="#revokeModal">
			      <span class="glyphicon glyphicon-ok"></span>&nbsp;Revoke Suspension </button>			      
		     </div>	
