...
<head>
	...
	<script type="text/javascript" src="resources/js/masters/Committee-relation.js"></script>	
...
<link rel="stylesheet" href="resources/css/validationEngine.jquery.css" type="text/css"/>	
	...
	<title>Committee Relation</title>
</head>
<body id="">
	<div class="container-fluid">
		...
		<div style="z-index:1; position: absolute; right: 5px; top: 80px; width: 300px;" id="sticky-notify"></div>
			...
			<div class="row">
				<div class="col-xs-11 pp-form-field" id="relation-list">
				</div>
		    </div>
			<div class="form-group">
				...
				<div class="row" >
					<div class="col-xs-2 pp-form-field clear" id="add-btn">
						...
						<span class="fa fa-plus"></span> Add Committee Relation</button>					
					</div>
				</div>				
		    </div>
		    <div id="form-div" style="display:none;">
		    <form action=""  method="get" id="relation">
		    		<input type="hidden" name="relationCode" id="relationCode"/>
			    	<div class="row"  >
						<div class="col-xs-4 pp-form-field " >
								<label for="localityName">Committee Relation Name : </label>
								<input type="text" name="relationName" id="relationName" class=" form-control validate[required, custom[onlyLetterNumberSp] clear"/>
						</div>
					</div>
					<div class="row" id="details-div">
						<div class="col-xs-2 pp-form-field " id="add-details-btn">
							<button type="button" class="btn btn-primary" onclick="javascript:addComRelation();">
					...
					<div id="edit-actions" class="form-inline" style="display:none;">
						<div class="row"> 
							<div class="col-xs-3 pp-form-field  " >
									<button type="button" class="btn btn-primary" onclick="javascript:editComRelation();">
									<span class="fa fa-edit"></span> Edit</button>
									<button type="button" class="btn btn-danger" onclick="javascript:deleteComRelation();">
