...
<script type="text/javascript" src="resources/js/jquery-1.11.3.js"></script>
	...
	<script type="text/javascript" src="resources/js/masters/religion-type.js"></script>
...
<script>
$(document).ready(function() {
	$("#add-religion-type-form").validationEngine({promptPosition: 'bottomRight'});
	$("#religion-form").validationEngine({promptPosition: 'bottomLeft'});
});
...
<body id="">
	<div class="container-fluid">
		...
		<div class="row">
				<div class="col-xs-8 pp-form-field" id="religion-type-list">
				</div>
		</div>	
		
		<div class="cols-xs-2">
				<button type="button" class="btn btn-primary"
					id="add-religion-type">
					<span class="fa fa-plus"></span> Add Religion Type
				</button>
			</div>
			
			<form action="religion-details" id="add-religion-type-form" 
				method="post" style="display: none;">
				<div class="row">
					<div class="col-xs-3 pp-form-field">
						<label for="notification-type-id">Religion Code: </label> <input
							type="text" name="religionCode" id="religion-type-code"
							class="form-control validate[required, custom[integer]] clear" />
					</div>
					<div class="col-xs-3 pp-form-field">
						<label for="notification-type-id">Religion Desc: </label> <input
							type="text" name="religionDesc" id="religion-type-desc"
							class="form-control validate[required] clear" />
					</div>
				</div>
				<div class="row">
					<div class="col-xs-4 pp-form-field">
						<button class="btn btn-success" onclick="validateReligionType();" type="submit" id="submit-btn">
							<span class="fa fa-check"></span> Submit
						</button>
						<button class="btn btn-danger" type="button" id="cancel-btn" onclick="hideReligionValidationMsg();">
			...
			<div id="form-div" style="display: none;">
				<form id="religion-form" action="religion-edit-religion-details" method="post">
					<div class="row">
						<div class="col-xs-3 pp-form-field" style="display: none;">
							<label for="agreement-id">Religion ID: </label> <input
								type="text" name="religionCode" id="religionCodeForEdit"
								class="form-control" readonly="readonly" />
						</div>

						<div class="col-xs-4 pp-form-field" id="">
							<label for="notificationTitle">Religion Desc: </label> <input
								type="text" name="religionDesc" id="religionDescForEdit" class="form-control validate[required] clear" />
						</div>
					</div>
					<div id="edit-actions" class="form-inline" style="display: none;">
						<div class="row">
							<div class="col-xs-3 pp-form-field">
								<button class="btn btn-success" onclick="validateEditReligionType();" type="submit" id="submit-btn2">
									<span class="fa fa-check"></span> Edit
								</button>
								<button type="button" class="btn btn-danger"
									onclick="javascript:deleteReligionType();">
