...
<head>
	...
	<script type="text/javascript" src="resources/js/masters/country.js"></script>	
	...
	<div class="container-fluid">
		<div class="content-section">
			<div class="row">
			    ...
			    <div class="row">				
		       <div class="col-xs-8 pp-form-field" id="Country-list">
				</div>
		    </div>
			<div class="form-group">
				<div class="row" >
					<div class="col-xs-2 pp-form-field" id="add-btn">
						...
						<span class="fa fa-plus"></span> Add Country </button>					
					</div>
					</div>
				</div>				
		    </div>
		    ...
		    <div id="form-div">
		    	<form name="country-type-form" action="" method="get" id="country-type-form">
		    	<input type="hidden" name="requestToken" value="${requestToken}" id="requestToken"/>
		    		<div id="details-div" style="display:none">
		    			<div class="row" >	
		    			<div class="col-xs-3 pp-form-field" id="coun-code">
									<label for="countryCode">Country Code: </label>
									<input type="text" name="countryCode" id="countryCode" class="form-control validate[required, maxSize[3]] clear"/><br></br>
									
							</div>					
							<div class="col-xs-3 pp-form-field" id="">
									<label for="countryname">Country Name: </label>
									<input type="text" name="countryName" id="countryName" class="form-control validate[required, custom[onlyLetterSp]] clear"/><br></br>
		    		...
		    		<div id="add-details-btn" style="display:none;">
		    		 <div class="row">
							<div class="col-xs-2 pp-form-field">
								<button type="button" class="btn btn-primary " onclick="javascript:addcountrydetails();">
					...
					<div id="edit-actions"  style="display:none;">
						<div class="row"> 
							<div class="col-xs-3 pp-form-field">
									<button type="button" class="btn btn-primary" onclick="javascript:editcountrytype();">
									<span class="fa fa-edit clear"></span> Edit</button>
									<button type="button" class="btn btn-danger" onclick="javascript:deletecountrytype();">
