...
<head>
	...
	<script type="text/javascript" src="resources/js/masters/currency.js"></script>	
	...
	<div class="container-fluid">
		<div class="content-section">
			<div class="row">
			    ...
			    <div class="row">				
		       <div class="col-xs-8 pp-form-field" id="Currency-list">
				</div>
		    </div>
			<div class="form-group">
				<div class="row" >
					<div class="col-xs-2 pp-form-field" id="add-btn">
						...
						<span class="fa fa-plus"></span> Add Currency </button>					
					</div>
					</div>
				</div>				
		    </div>
		    ...
		    <div id="form-div">
		    	<form name="currency-type-form" action="" method="get" id="currency-type-form">
		    	<input type="hidden" name="requestToken" value="${requestToken}" id="requestToken"/>
		    		<div id="details-div" style="display:none">
		    			<div class="row" >	
		    			<div class="col-xs-3 pp-form-field" id="curr-code">
									<label for="currencyCode">Currency Code: </label>
									<input type="text" name="currencyCode" id="currencyCode" class="form-control validate[required, maxSize[4]] clear"/><br></br>
									
							</div>					
							<div class="col-xs-3 pp-form-field" id="">
									<label for="currencyname">Currency Name: </label>
									<input type="text" name="currencyName" id="currencyName" class="form-control validate[required, custom[onlyLetterSp]] clear"/><br></br>
		    		...
		    		<div id="add-details-btn" style="display:none;">
		    		 <div class="row">
							<div class="col-xs-2 pp-form-field">
								<button type="button" class="btn btn-primary " onclick="javascript:addcurrencydetails();">
					...
					<div id="edit-actions"  style="display:none;">
						<div class="row"> 
							<div class="col-xs-3 pp-form-field">
									<button type="button" class="btn btn-primary" onclick="javascript:editcurrencytype();">
									<span class="fa fa-edit clear"></span> Edit</button>
									<button type="button" class="btn btn-danger" onclick="javascript:deletecurrencytype();">
