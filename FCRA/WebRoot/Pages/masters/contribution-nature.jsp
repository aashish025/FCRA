...
<head>
	...
	<script type="text/javascript" src="resources/js/masters/contribution-nature.js"></script>	
	
  
	<title>Society Acts</title>
</head>
<body id="">
	<div class="container-fluid">
		<div class="content-section">
			<div class="row">
			    ...
			    <div class="row">				
		       <div class="col-xs-8 pp-form-field" id="contribution-list">
				</div>
		    </div>
			<div class="form-group">
				<div class="row" >
					<div class="col-xs-2 pp-form-field" id="add-btn">
						...
						<span class="fa fa-plus"></span> Add Contribution Description </button>					
					</div>
					</div>
				</div>				
		    ...
		    <div id="form-div">
		    	<form name="contribution-type-form" action="" method="get" id="contribution-type-form">
		    	<input type="hidden" name="requestToken" value="${requestToken}" id="requestToken"/>
		    	<div id="details-div" style="display:none">
		    			<div class="row" >	
		    			<div class="col-xs-3 pp-form-field" id="act">
									<label for="contributionType">Contribution Type: </label>
									<input type="text" name="contributionType" id="contributionType" class="form-control validate[required, maxSize[2],custom[onlyNumberSp]] clear"/><br></br>
									
							</div>			
							<div class="col-xs-3 pp-form-field" id="">
									<label for="contributionName"> Contribution Description: </label>
									<input type="text" name="contributionName" id="contributionName" class="form-control validate[required, custom[onlyLetterSp]] clear"/><br></br>
		    		...
		    		<div id="add-details-btn" style="display:none;">
		    		 <div class="row">
							<div class="col-xs-2 pp-form-field">
								<button type="button" class="btn btn-primary " onclick="javascript:addcontributiondetails();">
					...
					<div id="edit-actions"  style="display:none;">
						<div class="row"> 
							<div class="col-xs-3 pp-form-field">
									<button type="button" class="btn btn-primary" onclick="javascript:editcontributiontype();">
									<span class="fa fa-edit clear"></span> Edit</button>
									<button type="button" class="btn btn-danger" onclick="javascript:deletecontributiontype();">
