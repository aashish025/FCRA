...
<head>
	...
	<script type="text/javascript" src="resources/js/masters/society-acts.js"></script>	
	...
	<div class="container-fluid">
		<div class="content-section">
			<div class="row">
			    ...
			    <div class="row">				
		       <div class="col-xs-8 pp-form-field" id="acts-list">
				</div>
		    </div>
			<div class="form-group">
				<div class="row" >
					<div class="col-xs-2 pp-form-field" id="add-btn">
						...
						<span class="fa fa-plus"></span> Add Society Acts </button>					
					</div>
					</div>
				</div>				
		    ...
		    <div id="form-div">
		    	<form name="acts-type-form" action="" method="get" id="acts-type-form">
		    	...
		    	<div id="details-div" style="display:none">
		    			...
		    			<div class="col-xs-3 pp-form-field" id="act">
									<label for="actCode">Society Acts Code: </label>
									<input type="text" name="actCode" id="actCode" class="form-control validate[required, maxSize[2],custom[onlyNumberSp]] clear"/><br></br>
									
							</div>			
							<div class="col-xs-3 pp-form-field" id="">
									<label for="actname">Society Acts Name: </label>
									<input type="text" name="actName" id="actName" class="form-control validate[required, custom[onlyLetterSp]] clear"/><br></br>
		    		...
		    		<div id="add-details-btn" style="display:none;">
		    		 <div class="row">
							<div class="col-xs-2 pp-form-field">
								<button type="button" class="btn btn-primary " onclick="javascript:addactdetails();">
					...
					<div id="edit-actions"  style="display:none;">
						<div class="row"> 
							<div class="col-xs-3 pp-form-field">
									<button type="button" class="btn btn-primary" onclick="javascript:editacttype();">
									<span class="fa fa-edit clear"></span> Edit</button>
									<button type="button" class="btn btn-danger" onclick="javascript:deleteacttype();">
