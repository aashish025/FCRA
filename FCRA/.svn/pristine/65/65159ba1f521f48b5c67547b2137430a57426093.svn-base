...
<head>
	...
	<script type="text/javascript" src="resources/js/masters/file-status.js"></script>	
	...
	<title>File Status Details</title>
</head>
<body id="">
	<div class="container-fluid">
		<div class="content-section">
			<div class="row">
			    ...
			    <div class="row">				
		       <div class="col-xs-8 pp-form-field" id="User-list">
				</div>
		    </div>
			<div class="form-group">
				<div class="row" >
					<div class="col-xs-2 pp-form-field" id="add-btn">
						...
						<span class="fa fa-plus"></span> Add File</button>					
					</div>
					</div>
				</div>				
		    </div>
		    ...
		    <div id="form-div">
		    	<form action="" method="get" id="file-status-form">
		    		<input type="hidden" name="filestatusId" id="filestatusId"/>
		    		<div id="details-div" style="display:none">
		    			<div class="row" >						
							<div class="col-xs-4 pp-form-field" id="">
									<label for="userTitle">File Type: </label>
									<input type="text" name="filestatusName" id="filestatusName" class="form-control validate[required, custom[onlyLetterNumberSp]] clear"/>
							</div>                            
						</div>
		    		</div>
		    		<div id="add-details-btn" style="display:none;">
		    		 <div class="row">
							<div class="col-xs-2 pp-form-field">
								<button type="button" class="btn btn-primary " onclick="javascript:adduserdetails();">
					...
					<div id="edit-actions"  style="display:none;">
						<div class="row"> 
							<div class="col-xs-3 pp-form-field">
									<button type="button" class="btn btn-primary" onclick="javascript:editfileStatus();">
									<span class="fa fa-edit clear"></span>Update</button>
									<button type="button" class="btn btn-danger" onclick="javascript:deletefilestatus();">
