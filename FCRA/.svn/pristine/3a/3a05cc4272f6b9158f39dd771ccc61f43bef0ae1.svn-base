...
public class ChangeAssociationDao extends BaseDao<ChangeAssociation, String, String>{
	...
	public ChangeAssociationDao(Connection connection) {
		super(connection);
		// TODO Auto-generated constructor stub
	}

	
	public List<AbstractRequest> getApplicationListDetailsChangeAss() throws Exception{
		...
		if(!(state==null || state.equals("")) && !(district==null || district.equals(""))){	
		 ...
		 query=new StringBuffer("SELECT a.rcn, " +
								...
								"  FROM fc_india a " +
								"  WHERE current_status!=1 and "+queryField+ "" );		
	...
	public List<List2> getApplicationListDetailsAsso(String appId) throws Exception{
		StringBuffer query=null;
		if(connection == null) {
			throw new Exception("Invalid connection");
		}			
	...
	public void getApplicationListChange(String appId,String myOfficeCode,String myUserId) throws Exception{		
		PreparedStatement statement=null;	
	...
	@Override
	public Integer insertRecord(ChangeAssociation object) throws Exception {
		getApplicationListDetailsAsso(object.getApplicationId());
         int rows=0,rows1=0;
		if(connection == null) {
			throw new Exception("Invalid connection");
		}
		String oldassocType = null;		
		StringBuffer query = new StringBuffer("Select ASSOCIATION_TYPE from Fc_India where rcn=? ");
		PreparedStatement statement = connection.prepareStatement(query.toString());
		statement.setString(1, object.getApplicationId());
		ResultSet rs = statement.executeQuery();
		if(rs.next()){
			oldassocType=rs.getString(1);
		}
		statement.close();
		
			
		StringBuffer query1= new StringBuffer("Insert INTO T_ASSO_TYPE_CHANGE_LOG( Rcn,OLD_TYPE,NEW_TYPE,ACTION_DATE,ACTION_BY)VALUES(?,?,?,SYSDATE,?)");
		PreparedStatement statement1 = connection.prepareStatement(query1.toString());
		statement1.setString(1, object.getApplicationId());
		statement1.setString(2, oldassocType);
		statement1.setString(3, object.getAssocType());
		statement1.setString(4, object.getActionBy());
		rows=statement1.executeUpdate();
		statement1.close();
		
		if(rows>0){
			StringBuffer query2= new StringBuffer("UPDATE Fc_India SET ASSOCIATION_TYPE=? WHERE rcn=?");
			PreparedStatement statement2 = connection.prepareStatement(query2.toString());
			statement2.setString(1, object.getAssocType());
			statement2.setString(2, object.getApplicationId());
	...
	@Override
	public Integer removeRecord(ChangeAssociation object) throws Exception {
	...
	@Override
	public List<ChangeAssociation> getAll() throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public List<KVPair<String, String>> getKVList(List<ChangeAssociation> list) {
		// TODO Auto-generated method stub
		return null;
	}
