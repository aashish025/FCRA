...
<head>
	...
	<script type="text/javascript" src="resources/js/masters/process-communication-stage.js"></script>
	...
	<div class="container-fluid">
		<div class="content-section">
			<div class="row">
			    ...
			    <div class="row">				
		       <div class="col-xs-8 pp-form-field" id="pcstage-list">
				</div>
		    </div>
		    ...
		    <div id="form-div">
		    	<form action="processcommunication-type-form" method="get" id="processcommunication-type-form">
		    		...
		    		<div id="details-div" style="display:none">
		    			<div class="row" >						
							<div class="col-xs-4 pp-form-field" id="">
									<label for="processcommunicationTitle"> Stage Description: </label>
									<input type="text" name="stageDesc" id="stageDesc" class="form-control validate[required, custom[onlyLetterSp]] clear"/>
							</div>
						</div>
		    		</div>
		    		<div id="add-details-btn" style="display:none;">
		    		 <div class="row">
							<div class="col-xs-2 pp-form-field">
								<button type="button" class="btn btn-primary " onclick="javascript:addpcstage();">
					...
					<div id="edit-actions"  style="display:none;">
						<div class="row"> 
							<div class="col-xs-3 pp-form-field">
									<button type="button" class="btn btn-primary" onclick="javascript:editpcstage();">
									<span class="fa fa-edit clear"></span> Edit</button>
									<button type="button" class="btn btn-danger" onclick="javascript:deletepcstage();">
