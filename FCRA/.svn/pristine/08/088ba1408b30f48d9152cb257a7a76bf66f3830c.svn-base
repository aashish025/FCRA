...
<head>
	...
	<script type="text/javascript" src="resources/js/masters/office-type.js"></script>	
    <script type="text/javascript" src="resources/js/masters/acquisition-type.js"></script>	
	...
	<title>Office Type Details</title>
</head>
<body id="">
	<div class="container-fluid">
		<div class="content-section">
			<div class="row">
			    ...
			    <div class="row">				
		       <div class="col-xs-8 pp-form-field" id="Office-list">
				</div>
		    </div>
			<div class="form-group">
				<div class="row" >
					<div class="col-xs-2 pp-form-field" id="add-btn">
						...
						<span class="fa fa-plus"></span> Add Office Type</button>					
					</div>
					</div>
				</div>				
		    </div>
		    ...
		    <div id="form-div">
		    	<form action="" method="get" id="office-type-form">
		    		...
		    		<div id="details-div" style="display:none">
		    			<div class="row" >	
							...
							<div class="col-xs-4 pp-form-field" >
									...
									<input type="text" name="officeType" id="officeType" class="form-control validate[required,maxSize[5] custom[onlyLetterNumber]] clear"/>
							</div>					
						<div class="col-xs-4 pp-form-field" id="">
									<label for="officeTitle">Office Name: </label>
									<input type="text" name="officeName" id="officeName"  class="form-control validate[required, custom[onlyLetterNumberSp]] clear"/>
                     </div>
                     </div>
		    	</div>
		    		...
		    		<div id="add-details-btn" style="display:none;">
		    		 <div class="row">
							<div class="col-xs-2 pp-form-field">
								<button type="button" class="btn btn-primary " onclick="javascript:addofficedetails();">
					...
					<div id="edit-actions"  style="display:none;">
						<div class="row"> 
							<div class="col-xs-3 pp-form-field">
									...
									<button type="button" class="btn btn-danger" onclick="javascript:deleteOfficetype();">
