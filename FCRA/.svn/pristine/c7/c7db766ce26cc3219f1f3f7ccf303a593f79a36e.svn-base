...
public class ExemptionAnnualPenalty {
	...
	public ExemptionAnnualPenalty(){
		
	}
	
	
	public ExemptionAnnualPenalty(String assoName, String remarks,
	...
	public ExemptionAnnualPenalty(String rcn, String assoName, String blockYear,
