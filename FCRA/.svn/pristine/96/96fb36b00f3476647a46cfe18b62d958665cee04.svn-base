...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="resources/js/masters/Block-Year.js"></script>	
		...
		<title>Block Year Details</title>
	</head>
	...
	<body id="">
		<div class="container-fluid">
			<div class="content-section">
				...
				<div class="row">
					<div class="col-xs-11 pp-form-field" id="blockyear-list"></div>
			    </div>
				<div class="form-group">
					<div class="row" >
						<div class="col-xs-2 pp-form-field clear" id="add-btn">
							<button type="button" class="btn btn-primary" onclick="javascript:initblock();">
							<span class="fa fa-plus"></span> Add Block Year</button>					
						</div>
					</div>				
			    </div>
			    <div id="form-div" style="display:none;">
				    <form action=""  method="get" id="blockyear">
				    <input type="hidden" name="requestToken" value="${requestToken}" id="requestToken"/>
 				    	<div class="row">
							<div class="col-xs-4 pp-form-field " id="code" style="display:none;" >
								<label for="localityName">Block Year : </label>
								<input type="text" name="blkyr" id="blkyr" class=" form-control validate[required, custom[onlyYears] clear"/>
								</div>
							<div class="col-xs-3 pp-form-field">
								<label for="notificationType" >Status:  </label>
								<select id="status" name="status"  class="form-control validate[required] clear">
						...
						<div class="row" id="details-div">
							<div class="col-xs-2 pp-form-field " id="add-details-btn">
								<button type="button" class="btn btn-primary" onclick="javascript:addBlockYear();">
						...
						<div id="edit-actions" class="form-inline" style="display:none;">
							<div class="row"> 
								<div class="col-xs-3 pp-form-field  " >
									<button type="button" class="btn btn-primary" onclick="javascript:editBlockYear();">
									<span class="fa fa-edit"></span> Edit</button>
									<button type="button" class="btn btn-danger" onclick="javascript:deleteBlockYear();">
