...
<head>
	...
	<script type="text/javascript" src="resources/js/masters/parent-menu.js"></script>	
...
<link rel="stylesheet" href="resources/css/validationEngine.jquery.css" type="text/css"/>	
	...
	<title>Parent Menu Details</title>
</head>
...
<body id="">
	<div class="container-fluid">
		<div class="content-section">
			...
			<div class="row">
				<div class="col-xs-11 pp-form-field" id="parentmenu-list">
				</div>
		    </div>
			<div class="form-group">
				<div class="row" >
					<div class="col-xs-2 pp-form-field clear" id="add-btn">
						<button type="button" class="btn btn-primary" onclick="javascript:initForm4();">
						<span class="fa fa-plus"></span> Add Parent Menu</button>					
					</div>
				</div>				
		    </div>
		    <div id="form-div" style="display:none;">
		     <form action=""  method="get" id="pmen">
			    	...
			    	<div class="row"  >
						<div class="col-xs-4 pp-form-field " >
								<label for="localityName">Parent Menu Name : </label>
								<input type="text" name="pmenuName" id="pmenuName" class=" form-control validate[required, custom[onlyLetterNumberSp] clear"/>
						</div>
					</div>
					<div class="row" id="details-div">
						<div class="col-xs-2 pp-form-field " id="add-details-btn">
							<button type="button" class="btn btn-primary" onclick="javascript:addPMenu();">
					...
					<div id="edit-actions" class="form-inline" style="display:none;">
						<div class="row"> 
							<div class="col-xs-3 pp-form-field">
									<button type="button" class="btn btn-primary" onclick="javascript:editPMenu();">
									<span class="fa fa-edit"></span> Edit</button>
									<button type="button" class="btn btn-danger" onclick="javascript:deletePMenu();">
