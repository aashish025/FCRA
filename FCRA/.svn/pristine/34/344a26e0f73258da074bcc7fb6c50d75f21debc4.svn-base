...
<head>
	...
	<script type="text/javascript" src="resources/js/services/exemption-annual-return-penalty.js"></script>	
	...
	<title>Exemption for Annual Return</title>
</head>
<body id="">
	<div class="container-fluid">
			...
			<div id="rcn-detail-data-div" >	
		        ...
		        <div class="row">
					<div class="col-xs-10" id="exemption-annual-table">
					</div>
			    </div>
				 <div class="">
						<div id="add-details-btn">
							<div class="row">
								<div class="col-xs-3 pp-form-field">
									<button type="button" class="btn btn-primary "onclick="javascript:openSearch();">
					...
					<span id="asso-details-title">Details of Exemption</span>
						...
						<div class="row">
						   <div class="col-xs-4 pp-form-field">
					              <label for="blkYear"> Select Block Year </label>
						            <div id = "tableBody">
						             </div>					 
							 </div>
						</div>
						...
						<div class="col-sm-3 pp-form-field">
						  ...
						  <div class="col-xs-3 pp-form-field">
								<label for="exemptionDays">Exemption allowed for (in days)</label>
								 <input type="text" name="exemptionDays" class="form-control validate[min[1],max[120]]" id="exemptionDays" value="15" />
					   		</div>
					   	</form>
					  </div>
