...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="resources/js/masters/District.js"></script>	
	...
	<body id="">
		<div class="container-fluid">
			<div class="content-section">
				...
				<div class="row">
					<div class="col-xs-11 pp-form-field" id="district-list"></div>
			    </div>
				<div class="form-group">
					<div class="row" >
						<div class="col-xs-2 pp-form-field clear" id="add-btn">
							...
							<span class="fa fa-plus"></span> Add District</button>					
						</div>
					</div>				
			    </div>
			    <div id="form-div" style="display:none;">
				    <form action=""  method="get" id="district">
 				    	<div class="row">
							<div class="col-xs-4 pp-form-field " id="code" style="display:none;" >
								<label for="localityName">District Code : </label>
								<input type="text" name="dcode" id="dcode" class=" form-control validate[required, custom[onlyNumberSp] clear"/>
							</div>
							<div class="col-xs-4 pp-form-field " >
								<label for="localityName">District Name : </label>
								<input type="text" name="dname" id="dname" class=" form-control validate[required, custom[onlyLetterNumberSp] clear"/>
							</div>
							<div class="col-xs-3 pp-form-field">
								<label for="notificationType" id="lgc">State Name :  </label>
								<select id="scode" name="scode"  class="form-control validate[required] clear">
								 	<option value="">Select State Name</option>
							 		<c:forEach items="${snameList}" var="nType">
						...
						<div class="row" id="details-div">
							<div class="col-xs-2 pp-form-field " id="add-details-btn">
								<button type="button" class="btn btn-primary" onclick="javascript:addDistrict();">
						...
						<div id="edit-actions" class="form-inline" style="display:none;">
							<div class="row"> 
								<div class="col-xs-3 pp-form-field  " >
									<button type="button" class="btn btn-primary" onclick="javascript:editDistrict();">
									<span class="fa fa-edit"></span> Edit</button>
									<button type="button" class="btn btn-danger" onclick="javascript:deleteDistrict();">
