...
public class GenerateExcelVirtualizer {	   
    public static String exportReportToExcel(String jrxmlPath, Map parameters,Connection connection, String fileName)
        throws JRException
        {
...
/*    public  static String asInline(String jrxmlPath, Map parameters,Connection connection, String fileName)
  ...
  /*  public static String asAttachment(String jrxmlPath, Map parameters,Connection connection,String fileName)
    ...
    public static String exportReportToCsv(String jrxmlPath, Map parameters,Connection connection, String fileName)
            throws JRException
            {
        		ServletRequestAttributes attr = (ServletRequestAttributes) RequestContextHolder.currentRequestAttributes();
                HttpServletResponse response = attr.getResponse();  
