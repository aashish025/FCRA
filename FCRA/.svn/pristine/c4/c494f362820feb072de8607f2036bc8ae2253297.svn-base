...
<head>
	...
	<script type="text/javascript" src="resources/js/masters/red-flag-category.js"></script>	
...
<body id="">
	<div class="container-fluid">
		<div class="content-section">
			...
			<div class="row">
				<div class="col-xs-11 pp-form-field" id="red-flag-list">
				</div>
		    </div>
			<div class="form-group">
				<div class="row" >
					<div class="col-xs-2 pp-form-field clear" id="add-btn">
						<button type="button" class="btn btn-primary" onclick="javascript:tabledata();">
						<span class="fa fa-plus"></span> Add Category</button>					
					</div>
				</div>				
		    </div>
		    <div id="form-div" style="display:none;">
		    <form action=""  method="get" id="red-flag">
		    <input type="hidden" name="requestToken" value="${requestToken}" id="requestToken"/>
			    	...
			    	<div class="row"  >
						<div class="col-xs-4 pp-form-field " >
								<label for="RedCategory">Category Description : </label>
								<input type="text" name="categoryName" id="categoryName" class=" form-control validate[required, custom[onlyLetterNumberSp] clear"/>
						</div>
					</div>
					<div class="row" id="details-div">
						<div class="col-xs-2 pp-form-field " id="add-details-btn">
							<button type="button" class="btn btn-primary" onclick="javascript:addCategory();">
					...
					<div id="edit-actions" class="form-inline" style="display:none;">
						<div class="row"> 
							<div class="col-xs-3 pp-form-field  " >
								<button type="button" class="btn btn-primary" onclick="javascript:editCategory();">
								<span class="fa fa-edit"></span> Edit</button>
								<button type="button" class="btn btn-danger" onclick="javascript:deleteCategory();">
