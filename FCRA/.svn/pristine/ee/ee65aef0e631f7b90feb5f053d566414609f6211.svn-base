...
public class ApplicationTrackingService extends Commons {
	...
	private void fetchBasicApplicationDetails() throws Exception {
		...
		StringBuffer query = new StringBuffer("SELECT APPLICATION_ID, TEMP_FILENO, AD.SERVICE_CODE, S.SERVICE_DESC, to_char(CREATED_ON, 'dd-mm-yyyy'), SECTION_FILENO, DOCUMENT_ID FROM V_APPLICATION_DETAILS AD, TM_SERVICE S WHERE APPLICATION_ID=? AND AD.SERVICE_CODE=S.SERVICE_CODE");
