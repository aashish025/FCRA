...
<head>
	...
	<script type="text/javascript" src="resources/js/masters/State.js"></script>	
...
<body id="">
	<div class="container-fluid">
		<div class="content-section">
			...
			<div class="row">
				<div class="col-xs-11 pp-form-field" id="state-list">
				</div>
		    </div>
			<div class="form-group">
				...
				<div class="row" >
					<div class="col-xs-2 pp-form-field clear" id="add-btn">
						...
						<span class="fa fa-plus"></span> Add State</button>					
					</div>
				</div>				
		    </div>
		    <div id="form-div" style="display:none;">
		    <form action=""  method="get" id="state">
		    		<!-- <input type="hidden" name="bankCode" id="bankCode"/> -->
			    	<div class="row"  >
			    	<div class="col-xs-4 pp-form-field " id="code" style="display:none;" >
								<label for="localityName">State Code : </label>
								<input type="text" name="scode" id="scode" class=" form-control validate[required, custom[onlyNumberSp] clear"/>
						</div>
						
						<div class="col-xs-4 pp-form-field " >
								<label for="localityName">State Name : </label>
								<input type="text" name="sname" id="sname" class=" form-control validate[required, custom[onlyLetterNumberSp] clear"/>
						</div>
						<div class="col-xs-4 pp-form-field " >
								<label for="localityName">LCode : </label>
								<input type="text" name="lcode" id="lcode" class=" form-control validate[required, custom[onlyNumberSp] clear"/>
						</div>
					</div>
					...
					<div class="row" id="details-div">
						<div class="col-xs-2 pp-form-field " id="add-details-btn">
							<button type="button" class="btn btn-primary" onclick="javascript:addState();">
					...
					<div id="edit-actions" class="form-inline" style="display:none;">
						<div class="row"> 
							<div class="col-xs-3 pp-form-field  " >
									...
									<button type="button" class="btn btn-primary" onclick="javascript:editState();">
									<span class="fa fa-edit"></span> Edit</button>
									<button type="button" class="btn btn-danger" onclick="javascript:deleteState();">
