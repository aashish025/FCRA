...
<head>
	...
	<script type="text/javascript" src="resources/js/masters/user-level.js"></script>
	...
	<title>User Level Details</title>
</head>
<body id="">
	<div class="container-fluid">
		<div class="content-section">
		    ...
		    <div id="form-div">
		    	<form action="" method="get" id="user-type-form">
		    		<input type="hidden" name="userTypeId" id="userTypeId"/>
		    		<div id="details-div" style="display:none">
		    			<div class="row" >						
							<div class="col-xs-4 pp-form-field" id="">
									<label for="userTitle">User Type: </label>
									<input type="text" name="userTypeName" id="userTypeName" class="form-control validate[required, custom[onlyLetterNumberSp]] clear"/>
							</div>
						</div>
		    		</div>
					...
					<div id="edit-actions"  style="display:none;">
						<div class="row"> 
							<div class="col-xs-3 pp-form-field">
									<button type="button" class="btn btn-primary" onclick="javascript:editUsertype();">
									<span class="fa fa-edit clear"></span>Update</button>
									<button type="button" class="btn btn-danger" onclick="javascript:deleteUsertype();">
