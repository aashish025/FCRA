...
// Fields
		...
		private String blueflaggedBy;
		private String blueflaggedOn;
		...
		public BlueFlaggedRcns(String rcn, String associationName, String state,
		...
		/** default constructor */
		public BlueFlaggedRcns() {
		}

		/** full constructor */
		public BlueFlaggedRcns(String rcn,String associationName, String state, String district,String blueflaggedOn, String blueflaggedBy, String remarks) {
			this.rcn = rcn;
			this.associationName=associationName;
			this.state = state;
			this.district=district;
			this.blueflaggedOn = blueflaggedOn;
			this.blueflaggedBy = blueflaggedBy;
			this.remarks=remarks;
		}
		/** full constructor */
		public BlueFlaggedRcns(String rcn,String associationName, String redFlagCategory, String blueflaggedOn,String blueflaggedBy) {
			this.rcn = rcn;
			this.associationName=associationName;
		...
		public BlueFlaggedRcns(String annualyear, String status){
		...
		public String getBlueflaggedBy() {
			return blueflaggedBy;
		}

		public void setBlueflaggedBy(String blueflaggedBy) {
			this.blueflaggedBy = blueflaggedBy;
		}

		public String getBlueflaggedOn() {
			return blueflaggedOn;
		}

		public void setBlueflaggedOn(String blueflaggedOn) {
			this.blueflaggedOn = blueflaggedOn;
		}
