...
import service.services.FetchInadvertentlyClarificationRequestServices;
...
public class ApplicationTracking {
	...
	public @ResponseBody List<String> pullApplicationDetails(@RequestParam String applicationId) throws Exception{
		...
		FetchInadvertentlyClarificationRequestServices tracker = new FetchInadvertentlyClarificationRequestServices();
